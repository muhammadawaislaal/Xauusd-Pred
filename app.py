...
# --- HEADER WITH MARQUEE ---
latest_notice = st.session_state.notice
st.markdown(f"""
<div class="header">
    <h2>XAU/USD AI Trading Predictor</h2>
...
if st.button("🔄 Run Now"):
    ...
    # Copyable signal block
    signal_text = format_signal_info(df['close'].iloc[-1], signal, ACCURACY)
    st.code(signal_text, language='')
...
# --- FOOTER ---
st.markdown("---")
st.markdown("<div class='footer'>© 2025 XAU/USD Predictor Pro | Built for Traders • Risk Disclosure Applies</div>", unsafe_allow_html=True)
